  ...
  return (
    <div className='shop-top-bar flex justify-between py-3 px-1 sm:px-4 border border-slate-300 border-solid'>
        <div className="product-view-mode">
            <a href='/Products' className={clsx("change-view block bg-none border-0 float-left leading-none cursor-pointer select-text ",
            {
        ...
        <div className="product-sort flex justify-center text-base">
          <p className="sortby">Sort By</p>
          <select name="sortby" id="Sortby" className="nice-select cursor-pointer border-slate-300 border-solid border w-24 sm:w-44 m-0 max-w-full rounded-sm bg-transparent indent-[0.1] px-2 font-normal">
