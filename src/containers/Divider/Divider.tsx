                ...
                <div className="row flex flex-wrap -start -ml-4 -mr-4">
                    <div className="col basis-7/12 flex-shrink-0 flex-grow-0 relative pr-4 pl-4">
                        <div className="divider-info m-0 p-0 gap-1 md:gap-2 text-justify max-w-fit  sm:text-left">
                            <h2 className="title text-xl leading-8 sm:text-2xl -mt-3 sm:leading-10 md:text-5xl md:leading[55px]-10 md:mb-2">Contrary to popular belief is not simply rand.</h2>
