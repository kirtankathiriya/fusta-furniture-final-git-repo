        ...
        <>
            <section className="grid grid-cols-1 md:grid-cols-2 bg-slate-100  font-normal">
                <div className='w-full tracking-widest p-10'>
                    ...
                    <p className='flex hover:text-red-500 cursor-pointer items-center'>
                        <Location clasName="h-5"/>
                        184 Main Rd E,St Albans VIC 3021,Australia</p>
                    <p className=' flex hover:text-red-500 cursor-pointer items-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
