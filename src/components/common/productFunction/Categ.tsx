      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
        {productData.map((product, index) => (
          <div className="box1 pb-7 flex justify-center flex-col text-center" key={index}>
            <div className='relative group bg-slate-600 justify-center items-center'>
              <div>
              ...
              <div className=""><img src={product.image} alt='not found' className='group-hover:opacity-50' /></div>
              <Hover />
            </div>
            <div>
