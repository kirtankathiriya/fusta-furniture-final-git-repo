...
>>>>>>> 435838422fb32c8f334a3d129f9e9564bd8cc972
        <div className="relative">
          <Image src={i1} alt="yellow chair photo" className="w-fit" />
          <div className="absolute inset-0 flex flex-col justify-center items-start text-white bg-opacity-30 p-6">
            <h3 className="text-2xl">30% Off</h3>
            <h2 className="text-4xl font-bold">Chair Collection</h2>
            <a href="#" className="mt-4 px-6 py-2 bg-yellow-400 hover:bg-yellow-300 rounded-md  font-semibold uppercase">Shop Now</a>
          </div>
        </div>

        <div className="relative">
          <Image src={i2} alt="yellow chair photo" className="w-fit" />
          <div className="absolute inset-0 flex flex-col justify-center items-start text-white bg-opacity-30 p-6">
            <h3 className="text-2xl">30% Off</h3>
            <h2 className="text-4xl font-bold">Chair Collection</h2>
            <a href="#" className="mt-4 px-6 py-2 bg-red-400 hover:bg-red-300 rounded-md font-semibold uppercase">Shop Now</a>
          </div>
        </div>
      </div>
    </section>
