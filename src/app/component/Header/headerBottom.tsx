...
export const HeaderBottom = () => {
  ...
  return (
    <header className='flex items-center shadow-sm sticky bg-white h-[83px] top-0 z-10 justify-between my-8  '>
      ...
      <div className="hidden md:block z-10">
        <ul className='flex w-full font-normal'>
          <li
          ...
          <li className='relative ml-3'>
            <a href="#" className='hover:text-[#E97730]'>Blog</a>
          </li>
