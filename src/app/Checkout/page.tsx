                    ...
                    <div className='mt-7 ml-5'>
                        <div className='contact flex justify-between'>
                            ...
                            <p className='text-black-100'>
                                Have an account ?{' '}
                                <a href='http://localhost:3000/Account/Loginpage' className='text-[rgb(233,119,48)] underline'>
                                    Log in
                                </a>
                            </p>
                        </div>
                        <form action='#'>
                            ...
                            <input type='email' placeholder='Email or Mobile Phone Number' className='w-full p-2 mt-3' />

                            <div className='flex flex-row gap-2 mt-1'>
                                <input type='checkbox' name='checkBox' id='checkBox' className='accent-orange-400 h-5 w-5' />
                            ...
                            <div className='flex flex-row gap-2'>
                                <label>
                                    <input type='checkbox' className='accent-orange-400 h-5 w-5' />
                                </label>
                            ...
                            <div className='font-semibold mt-4'>
                                ...
                                <p className='text-slate-400 font-normal p-5'>Enter Your Shipping Address To View Available Shipping Method</p>
                            </div>

                            <div className='payment'>
                                <h2 className='font-semibold text-2xl'>Payment</h2>
                                <p className='text-slate-400 font-normal p-5'>All Transactions Are Secure And Encrypted</p>
                                <p className='p-5 border-1	border-orange-500 rounded bg-[#FEF4F2]'>Cash On Delivery (COD)</p>
                            </div>
